...
import { fetchTrendingTracks } from "../../services/api/trackService";
import type { Daum } from "../../types/TrackResponse";
import Blaze from "../../assets/Blaze.png";

export const Home = () => {
  const [tracks, setTracks] = useState<Daum[]>([]);
  ...
  return (
    <div className="min-h-screen w-full bg-black p-2">
      {/* Header estilo Spotify - Full width */}
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div className="display flex flex-col justify-center">
              ...
              <p className="text-zinc-300">
                Trending tracks from Audius • {tracks.length} songs
              </p>
            </div>
          </div>
